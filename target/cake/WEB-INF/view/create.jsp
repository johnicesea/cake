...
<body>
	...
	<div class="container-narrow">
		...
		<div class="masthead">
			<h3 class="muted">新建订单</h3>
		</div>

		<hr>

		<form class="form-horizontal" action="<c:url value="/order/save"/>" method="post">
			<div class="control-group">
				<label class="control-label" for="inputEmail">客户姓名:</label>
				<div class="controls">
					<input type="text" name="custName" placeholder="客户姓名">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="inputPassword">客户地址:</label>
				<div class="controls">
					<input type="text" name="custAddr" placeholder="客户地址">
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="cakeName" placeholder="蛋糕名称">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="inputPassword">订购数量:</label>
				<div class="controls">
					<input type="text" name="count" placeholder="订购数量">
				</div>
			</div>
